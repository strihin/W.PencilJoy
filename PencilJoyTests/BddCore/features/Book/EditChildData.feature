...
Scenario Outline: The user edits child's data with correct data
	...
	When The user edits fields with correct data as <Username> , <NumberMonth> , <NumberDay> <numberSex> , <NumberCharacter>
...
Scenario Outline:  The user edits child's data with incorrect data
	Given The user is a customer
	And The user is on the edit book page
	When The user edits fields with incorrect data as <Username> , <NumberMonth> , <NumberDay> <numberSex> , <NumberCharacter>
