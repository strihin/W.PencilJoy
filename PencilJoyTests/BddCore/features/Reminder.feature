...
Scenario Outline: The user fills form for the letter reminder with all activated checkboxes
	Given The user is a customer
	And The user is on the preview page 
	And The popup Remind me later should be appear
	And The user fills the field Your email with correct data as <Email>
...
Examples: 
| Email                 |
| qaengineer6@yahoo.com |

@55days @previewPage  @positive
Scenario Outline: The user fills form for the letter reminder before 55 days
	Given The user is a customer
	And The user is on the preview page 
	And The popup Remind me later should be appear
	When The user fills the field Your email with correct data as <Email>
	And The user clicks the checkbox "55 days before December 25th"
...
Scenario Outline: The user fills form for the letter reminder before 30 days
	Given The user is a customer
	And The user is on the preview page 
	And The popup Remind me later should be appear
	When The user fills the field Your email with correct data as <Email>
	And The user clicks the checkbox "30 days before"
	And The user fills date in the datepicker
	And The user clicks the button Set reminder
	Then The popup Remind me later should be disappear
	And The popup Your reminder is set should be appear
Examples: 
...
Scenario Outline: The user compares emails in the popups
	Given The user is a customer
	And The user is on the preview page 
	And The popup Remind me later should be appear
	And The user fills the field Your email with correct data as <Email>
	And The user clicks the checkbox "55 days before December 25th"
	When The user clicks the button Set reminder
	Then The string in the popup Your reminder is set should have value as <Email>
Examples: 
| Email                 |
| qaengineer6@yahoo.com |
...
Scenario Outline: The user fills form for the letter reminder before 30 days without selected date
	Given The user is a customer
	And The user is on the preview page 
	And The popup Remind me later should be appear
	And The user fills the field Your email with correct data as <Email>
...
| qaengineer6@yahoo.com |
 ...
 Scenario Outline: The user doesn`t checked any checkbox in the form for the letter reminder
	Given The user is a customer
	And The user is on the preview page 
	And The popup Remind me later should be appear
	And The user fills the field Your email with correct data as <Email>
